...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(err.response?.data?.detail || "Gagal melakukan registrasi.");
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <main className="flex min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="hidden lg:flex flex-1 flex-col justify-between p-12 bg-emerald-950/10 border-r border-slate-900">
        ...
        <div>
          ...
          <h1 className="text-4xl font-bold mb-4 tracking-tight">Bergabung dengan <br/> Infrastruktur SmartConvert.</h1>
          <p className="text-slate-400 font-light max-w-sm">Mulai optimasi penjualan deposito Anda dengan kekuatan Predictive Intelligence.</p>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-8 lg:px-24">
        <div className="max-w-sm w-full mx-auto">
          ...
          <p className="text-sm text-slate-500 mb-8 font-light">Daftarkan identitas sales Anda untuk akses sistem.</p>
